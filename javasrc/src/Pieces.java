...
public class Pieces {
    ...
    public boolean comparePiece(Piece[] pieces) {
        ...
        return pieces[0].getColor() == pieces[1].getColor() && pieces[0].getColor() == pieces[2].getColor()
     ...
     * @return the id of all unplaced pieces
     */
